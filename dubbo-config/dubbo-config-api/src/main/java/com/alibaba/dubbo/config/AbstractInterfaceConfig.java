...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    //Mock配置类
    protected MockSystemUrlConfig mockSystemUrlConfig;
        ...
        if (registries != null && registries.size() > 0) {
            for (RegistryConfig config : registries) {
                ...
                if (address != null && address.length() > 0 
                    ...
                    //测试==============
                    appendParameters(map, mockSystemUrlConfig);
    ...
    //测试用的=================
    public MockSystemUrlConfig getMockSystemUrlConfig() {
        return mockSystemUrlConfig;
    }

    public void setMockSystemUrlConfig(MockSystemUrlConfig mockSystemUrlConfig) {
        this.mockSystemUrlConfig = mockSystemUrlConfig;
    }
